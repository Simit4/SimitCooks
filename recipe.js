...
// YouTube embed helper (unchanged)
...
// ONLY CHANGE NEEDED: Updated URL parsing
async function fetchAndRenderRecipe() {
  // Get slug from clean URL path (/recipe/slug-name)
  ...
  // Render recipe (original code unchanged)
  ...
  // Equipment loading (original code unchanged)
